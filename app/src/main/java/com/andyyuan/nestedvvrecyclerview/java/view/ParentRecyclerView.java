...
import com.andyyuan.nestedvvrecyclerview.UIUtils;
import com.andyyuan.nestedvvrecyclerview.java.adapter.MultiTypeAdapter;
import com.andyyuan.nestedvvrecyclerview.java.utils.FlingHelper;

import java.util.concurrent.atomic.AtomicBoolean;
/**
 * author : AndyYuan
 * date   : 2020/12/9 000915:02
 * desc   : 最外层的RecyclerView 即父类RecyclerView
 * version: 2.0
 */
    ...
    public void initLayoutManager(Context context) {
        LinearLayoutManager layoutManager = new LinearLayoutManager(context) {
            ...
            public boolean canScrollVertically() {
                ...
                //子recycleview 未滑动到顶部父recycleview就开始滑动 按照他说的在父控件里面不判断canScrollVertically.get()这个就可以了 不知道啥问题
